...
const UserCard = (props: any) => {
  ...
  return (
          <Flex as={NavLink} to={props.current_user ? '/home/my_profile' : `/home/user/${props.user_id}`} maxWidth={'800px'}  width={"90%"} ml='20px' mb={'20px'} alignSelf={'center'} alignItems={'center'} borderBottom={'1px'} borderColor={'gray.600'} p={'10px'}>
